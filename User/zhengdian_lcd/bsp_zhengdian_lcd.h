/**
  ...
  ******************************************************************************
  */
#ifndef __BSP_ZHENGDIAN_LCD_H
#define	__BSP_ZHENGDIAN_LCD_H
...
//////////////////////////////////////////////////////////////////////////////////	 
//-----------------LCD端口定义---------------- 
#define	LCD_LED 		*((volatile unsigned long  *)(((0x40020414 & 0xF0000000)+0x2000000+((0x40020414 &0xFFFFF)<<5)+(15<<2)) )) 
//MEM_ADDR(GPIOB_ODR_Addr,15)  		//LCD背光    		 PB15 	    
//LCD地址结构体
typedef struct
{
